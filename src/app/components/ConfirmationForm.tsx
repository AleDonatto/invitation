          ...
          <div className="bg-white/50 backdrop-blur-sm vintage-border rounded-lg p-8 md:p-12">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center pt-4">
                <button
                  type="submit"
                  className="cursor-pointer px-10 py-3 bg-rose-600/80 hover:bg-rose-700/80 text-white rounded-full transition-all duration-300 shadow-sm hover:shadow-md transform hover:-translate-y-0.5 font-cormorant text-lg tracking-wider backdrop-blur-sm"
                >
                  Sí asistiré
                </button>
              </div>
